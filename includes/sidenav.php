<?php
echo '
<nav class="col-1 col-sm-1 col-md-3 col-lg-3  sm-screen bg-secondary" style="max-width: 275px">
        <ul class="nav flex-column nav-pills overflow-hidden nav-fill mt-5">
            <li class="nav-item">
